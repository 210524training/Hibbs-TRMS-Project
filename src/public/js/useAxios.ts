import { sendEmployeeLogin,sendSupervisorLogin,sendDeptHeadLogin,sendBenCoLogin } from "../../remote/sendtobackend";
...
const navbarContent = `<a class="navbar-brand" href="/">TRMS</a>
...
async function sendLogin() {
  ...
  const response = await sendEmployeeLogin(usernameInput.value,passwordInput.value);
